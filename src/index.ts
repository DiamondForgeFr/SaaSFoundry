...
program
  ...
  // Output language
  .option('--language <tag>', 'Language the AI writes in — SRS, tickets, code comments (BCP-47 tag, default: en)')
  // Advanced skills
...
program
  ...
  .option('--agent-friendly', 'Output a Markdown report for agent initialization (exit code 0)')
  .option('--claude-friendly', 'Compatible alias for --agent-friendly')
